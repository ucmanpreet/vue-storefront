import { useCartFactory, useBillingFactory, useCategoryFactory, useFacetFactory, useForgotPasswordFactory, useMakeOrderFactory, useProductFactory, useReviewFactory, useShippingFactory, useShippingProviderFactory, useStoreFactory, useUserFactory, useUserBillingFactory, useUserOrderFactory, useUserShippingFactory, useWishlistFactory } from '@vue-storefront/core';
...
var params$b = {
  ...
  load: function (context, _a) {
    const customQuery = _a.customQuery;
  ...
  addItem: function (context, _a) {
    _a.currentCart; const product = _a.product; const quantity = _a.quantity; const customQuery = _a.customQuery;
    return __awaiter(void 0, void 0, void 0, function () {
      let data; let addItemToCartResults;
      let _b; let _c;
  ...
  removeItem: function (context, _a) {
    _a.currentCart; const product = _a.product; _a.customQuery;
    return __awaiter(void 0, void 0, void 0, function () {
      let params; let removeItemToCartResults;
      let _b; let _c;
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
  ...
  updateItemQty: function (context, _a) {
    _a.currentCart; const product = _a.product; const quantity = _a.quantity; _a.customQuery;
    return __awaiter(void 0, void 0, void 0, function () {
      let params; let updateItemToCartResults;
      let _b; let _c;
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
  ...
  isInCart: function (context, _a) {
    const currentCart = _a.currentCart; const product = _a.product;
    if ((currentCart === null || currentCart === void 0 ? void 0 : currentCart.items) && (currentCart === null || currentCart === void 0 ? void 0 : currentCart.items.length) > 0) {
      for (let _i = 0, _b = currentCart.items; _i < _b.length; _i++) {
        const cartItem = _b[_i];
...
const useCart = useCartFactory(params$b);
...
const params$a = {
  ...
  save: function (context, _a) {
    const params = _a.params; const billingDetails = _a.billingDetails; _a.customQuery;
    return __awaiter(void 0, void 0, void 0, function () {
      let excludeIndex; let shippingAddress; let key; let paramDetails; let saveBillingResults; let paymentMethods;
...
const useBilling = useBillingFactory(params$a);

const params$9 = {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  categorySearch: function (context, _a) {
    let _b; let _c; let _d; return __awaiter(void 0, void 0, void 0, function () {
      let _e; let categoriesResult; let categoryTreeResults;
      _a.customQuery; const params = __rest(_a, ['customQuery']);
...
const useCategory = useCategoryFactory(params$9);
...
const factoryParams$2 = {
  ...
  search: function (context, params) {
    return __awaiter(void 0, void 0, void 0, function () {
      let productListResults; let categoryResult; let categoryParams;
...
const useFacet = useFacetFactory(factoryParams$2);

const factoryParams$1 = {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  resetPassword: function (context, _a) {
    const email = _a.email; _a.customQuery;
    return __awaiter(void 0, void 0, void 0, function () {
      let passwordResult;
      let _b;
      return __generator(this, function (_c) {
...
const useForgotPassword = useForgotPasswordFactory(factoryParams$1);
...
const factoryParams = {
  ...
  make: function (context, _a) {
    _a.customQuery;
    return __awaiter(void 0, void 0, void 0, function () {
      let shippingAddress; let billingAddress; let shippingRate; let paymentMethod; let orderResults; let orderResponse;
      let _b; let _c; let _d; let _e; let _f; let _g; let _h; let _j; let _k; let _l;
...
const useMakeOrder = useMakeOrderFactory(factoryParams);

const params$8 = {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  productsSearch: function (context, params) {
    return __awaiter(void 0, void 0, void 0, function () {
      let _a; let productDetailResults; let newProductResults; let pageNumber; let featuredProductResults; let relatedProductResults;
...
const useProduct = useProductFactory(params$8);

const params$7 = {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  searchReviews: function (context, params) {
    return __awaiter(void 0, void 0, void 0, function () {
      let _a; let productReviewResults; let removeResults;
      let _b; let _c; let _d; let _e; let _f;
      return __generator(this, function (_g) {
        switch (_g.label) {
          case 0:
...
const useReview = useReviewFactory(params$7);
...
const params$6 = {
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  save: function (context, _a) {
    const shippingDetails = _a.shippingDetails; const customQuery = _a.customQuery;
    return __awaiter(void 0, void 0, void 0, function () {
      let params; let saveShippingResults; let shippingResponse;
      let _b; let _c;
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
...
const useShipping = useShippingFactory(params$6);
...
const params$5 = {
  ...
  load: function (context, _a) {
    const customQuery = _a.customQuery;
    return __awaiter(void 0, void 0, void 0, function () {
      let shippingAddress; let billingAddress; let shippingRate; let params_1; let paymentMethodResults; let paymentMethods;
      let _b; let _c; let _d; let _e; let _f; let _g; let _h; let _j; let _k;
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  save: function (context, _a) {
    const shippingMethod = _a.shippingMethod; const customQuery = _a.customQuery;
    return __awaiter(void 0, void 0, void 0, function () {
      let params; let shippingMethodResults; let params_2; let paymentMethodResults;
...
const useShippingProvider = useShippingProviderFactory(params$5);
...
var params$4 = {
  ...
  load: function (context) {
    return __awaiter(void 0, void 0, void 0, function () {
      let customerToken; let user_data; let loginResult; let customerDetail;
      let _a;
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
  ...
  updateUser: function (context, _a) {
    _a.currentUser; const updatedUserData = _a.updatedUserData;
    return __awaiter(void 0, void 0, void 0, function () {
      let updateResult; let userData;
      let _b; let _c;
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
  ...
  logIn: function (context, params) {
    return __awaiter(void 0, void 0, void 0, function () {
      let loginResult; let loginResultResponse;
  ...
  changePassword: function (context, _a) {
    const currentUser = _a.currentUser; const currentPassword = _a.currentPassword; const newPassword = _a.newPassword;
    return __awaiter(void 0, void 0, void 0, function () {
      let params; let updatePasswordResult;
      let _b; let _c;
      return __generator(this, function (_d) {
        switch (_d.label) {
          case 0:
...
const useUser = useUserFactory(params$4);
...
const useUserBilling = useUserBillingFactory(params$3);
...
const useUserOrder = useUserOrderFactory(params$2);
...
const useUserShipping = useUserShippingFactory(params$1);
...
var params = {
  ...
  load: function (context, params) {
    return __awaiter(void 0, void 0, void 0, function () {
      let wishlistParams; let wishlistResult;
      let _a; let _b; let _c; let _d; let _e; let _f;
      return __generator(this, function (_g) {
        switch (_g.label) {
          case 0:
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  addItem: function (context, _a) {
    const currentWishlist = _a.currentWishlist; const product = _a.product;
    return __awaiter(void 0, void 0, void 0, function () {
      let data; let addWishlistResults; let wishlistResponse;
      let _b;
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
  ...
  removeItem: function (context, _a) {
    const currentWishlist = _a.currentWishlist; const product = _a.product;
    return __awaiter(void 0, void 0, void 0, function () {
      let data; let removeResults; let wishlistResponse;
      let _b;
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
  ...
  isInWishlist: function (context, _a) {
    ...
    let exist = false;
    const user = (_b = context === null || context === void 0 ? void 0 : context.user) === null || _b === void 0 ? void 0 : _b.user.value;
    if ((currentWishlist === null || currentWishlist === void 0 ? void 0 : currentWishlist.results) && (currentWishlist === null || currentWishlist === void 0 ? void 0 : currentWishlist.results.length) > 0) {
      for (let _i = 0, _c = currentWishlist.results; _i < _c.length; _i++) {
        const wishlistProduct = _c[_i];
...
const useWishlist = useWishlistFactory(params);
...
function getBreadcrumbs$2(category) {
  ...
  if (category === null || category === void 0 ? void 0 : category.breadcrumbs) {
    for (let _i = 0, _a = Object.entries(category === null || category === void 0 ? void 0 : category.breadcrumbs); _i < _a.length; _i++) {
      const _b = _a[_i]; _b[0]; const value = _b[1];
      breadcrumbs.push({
        text: value.name,
...
function getName(product) {
  ...
  if (typeof product !== 'undefined' && typeof product.productFlats !== 'undefined') {
    for (let _i = 0, _a = product.productFlats; _i < _a.length; _i++) {
      const productFlat = _a[_i];
...
function getGallery(product) {
  ...
  const images = [];
  for (let _i = 0, _a = product.cacheGalleryImages; _i < _a.length; _i++) {
    const image = _a[_i];
    images.push({
...
function getConfigurableData(product) {
  ...
  if (typeof product !== 'undefined' && typeof product.configutableData !== 'undefined') {
    ...
    for (let _i = 0, _a = product.configutableData.attributes; _i < _a.length; _i++) {
      const attribute = _a[_i];
...
function getTotalReviews$1(product) {
  ...
  if (typeof product !== 'undefined' && typeof product.reviews !== 'undefined') {
    for (let _i = 0, _a = product.reviews; _i < _a.length; _i++) {
      const review = _a[_i];
...
function getItemAttributes$2(item, filterByAttributeName) {
  ...
  const attributes = {};
  const additionalData = JSON.parse(item === null || item === void 0 ? void 0 : item.additional);
  if (additionalData === null || additionalData === void 0 ? void 0 : additionalData.attributes) {
    for (const attribute in additionalData === null || additionalData === void 0 ? void 0 : additionalData.attributes) {
      if (Object.prototype.hasOwnProperty.call(additionalData === null || additionalData === void 0 ? void 0 : additionalData.attributes, attribute)) {
        const element = additionalData === null || additionalData === void 0 ? void 0 : additionalData.attributes[attribute];
...
function getTotals$1(cart) {
  ...
  const selectedShippingRate = ((_a = cart === null || cart === void 0 ? void 0 : cart.selectedShippingRate) === null || _a === void 0 ? void 0 : _a.price) || 0;
  return {
...
function getGrouped(params, criteria) {
  ...
  const filters = [];
  const categoryDetail = (_f = (_e = (_d = (_c = (_b = params === null || params === void 0 ? void 0 : params.data) === null || _b === void 0 ? void 0 : _b.categoryDetail) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d.categories) === null || _e === void 0 ? void 0 : _e.data) === null || _f === void 0 ? void 0 : _f[0];
  const filterableAttributes = (_g = params === null || params === void 0 ? void 0 : params.data) === null || _g === void 0 ? void 0 : _g.filterableAttributes;
...
function getSortOptions(params) {
  ...
  if ((_a = params === null || params === void 0 ? void 0 : params.input) === null || _a === void 0 ? void 0 : _a.filters) {
    for (const key in (_b = params === null || params === void 0 ? void 0 : params.input) === null || _b === void 0 ? void 0 : _b.filters) {
...
function getCategoryTree(params) {
  ...
  const categoryDetail = (_d = (_c = (_b = (_a = params === null || params === void 0 ? void 0 : params.categoryDetail) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.categories) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d[0];
  return {
...
function getBreadcrumbs(params) {
  let _a; let _b; let _c; let _d;
  const category = ((_d = (_c = (_b = (_a = params === null || params === void 0 ? void 0 : params.categoryDetail) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.categories) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d[0]) || [];
...
function getItems$2(reviewItems) {
  ...
  if (Array.isArray(reviewItems)) {
    for (let _i = 0, reviewItems_1 = reviewItems; _i < reviewItems_1.length; _i++) {
      const reviewDetail = reviewItems_1[_i];
...
function getAverageRating(reviewItems) {
  ...
  let total = 0;
  for (let _i = 0, reviewItems_2 = reviewItems; _i < reviewItems_2.length; _i++) {
    const review = reviewItems_2[_i];
    total += review.rating;
  }
...
function getFullName(user) {
  ...
  return String(user === null || user === void 0 ? void 0 : user.name) || '';
}
// eslint-disable-next-line @typescript-eslint/no-unused-vars
...
function getAddresses(shipping, criteria) {
  ...
  if (shipping.addresses && shipping.addresses.length > 0) {
    for (let _i = 0, _a = shipping.addresses; _i < _a.length; _i++) {
      const address = _a[_i];
